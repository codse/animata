...
export default function FlightWidget() {
  ...
  return (
    <div className="flex h-48 w-48 text-black">
      <div className="z-10 flex h-full w-[25%] flex-col rounded-l-3xl bg-gradient-to-b from-blue-100 to-blue-300">
        <img
      ...
      <div className="relative h-full w-[75%] rounded-3xl rounded-l bg-gradient-to-b from-blue-100 to-teal-100 p-2 text-sm">
        <div className="absolute -left-1 -top-2 z-10 h-4 w-4 rounded-full bg-white"></div>
        ...
        <div className="absolute -bottom-2 -left-1 z-10 h-4 w-4 rounded-full bg-white"></div>
      </div>
    </div>
  );
}
