...
export default function ScoreBoard({
  ...
  return (
    <div className="group/board flex size-52 flex-col rounded-3xl border bg-background p-4 shadow-sm shadow-black/15 transition-shadow duration-700 dark:border-zinc-700">
