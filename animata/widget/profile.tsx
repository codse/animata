  ...
  return (
    <div className="group flex min-h-52 w-52 flex-col items-center justify-center rounded-lg bg-gray-200 p-3 shadow-sm transition-all duration-700 hover:shadow-black/25">
      <img
        ...
        className="h-16 w-16 rounded-full duration-mid ease-in-out group-hover:scale-110"
      />
      ...
      <div className="mt-2 flex w-full flex-row justify-evenly rounded-3xl bg-gray-50 p-2">
        ...
        <a href="https://facebook.com/">
          <Facebook size={16} className="duration-700 hover:scale-110" />
        </a>
      </div>
    </div>
  );
