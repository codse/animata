  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="pointer-events-none absolute left-0 top-0 z-50 rounded-full bg-blue-800/80 px-4 py-2 text-sm font-bold text-white opacity-0 delay-150 duration-100 group-hover:opacity-100 group-hover:transition-none group-hover:delay-0"
      >
        Read more &rarr;
      </div>
    </div>
