  ...
  return (
    <div className="flex py-12">
      {data.map((item) => (
        <div
          key={item.name}
          className="scale-1 group relative z-0 -ml-4 flex items-center transition-all duration-300 ease-in-out hover:z-10 hover:scale-110"
        >
          <div className="relative overflow-hidden rounded-full bg-white">
            ...
            <img
              src={item.image}
              alt={item.name}
              className="m-2 size-12 rounded-full object-cover"
            />
          </div>
