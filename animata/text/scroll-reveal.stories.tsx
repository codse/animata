  ...
  args: {
    ...
    children: (
      <>
        ...
        <Baby className="scroll-baby size-5 transition-opacity duration-75 ease-in-out md:size-8" />{" "}
        as you scroll down the page{" "}
        <File className="scroll-file size-5 transition-opacity duration-75 ease-in-out md:size-8" />
        .
