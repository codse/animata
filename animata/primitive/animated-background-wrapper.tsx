...
function BeamBackground({ show, intensity }: { show: boolean; intensity: Intensity }) {
  ...
  return (
    <>
      <div
        aria-hidden="true"
        className="absolute left-0 top-[-50%] h-[200%] w-[40%] bg-linear-to-r from-transparent via-white to-transparent"
        style={{
      ...
      <div
        aria-hidden="true"
        className="absolute left-0 top-[-50%] h-[200%] w-[12%] bg-linear-to-r from-transparent via-white to-transparent"
        style={{
