...
export function ComponentCard({
  ...
  return (
    <section
      className={cn(
        "relative flex h-full flex-col border border-border bg-gray-50 shadow-(--shadow-card) transition-shadow duration-300 hover:shadow-(--shadow-card-hover) dark:border-zinc-600 dark:bg-zinc-800",
        className,
        {
          "rounded-(--radius-card)": rounded,
        },
      )}
    >
      <header
        className={cn(
          ...
          {
            "rounded-tl-(--radius-card) rounded-tr-(--radius-card)": rounded,
            "px-6": !rounded,
          },
        )}
      >
