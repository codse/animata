...
export function Announcement({ text }: { text: string }) {
  return (
    <div className="group relative isolate z-50 mx-auto w-fit cursor-pointer p-4">
      <div className="rounded-lg bg-linear-to-r from-purple-100 to-yellow-100 p-1 shadow-lg transition-all duration-300 ease-in-out group-hover:scale-105 group-hover:shadow-xl">
