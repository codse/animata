...
If the new type is a **top-level category** (new sidebar section), you also need a category glyph for `/components`. Follow [category glyph tiles](/docs/contributing/category-glyphs) and `animata/skeleton/CATEGORY-GLYPHS.md`.
