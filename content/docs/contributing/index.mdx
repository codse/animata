...
When you add a **new component category**, also read [category glyph tiles](/docs/contributing/category-glyphs) — the SVG pictograms on `/components` follow a strict three-shade, stroke-tier spec.
