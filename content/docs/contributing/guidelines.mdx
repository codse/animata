...
Use `yarn animata:new` for creating new components. This command will add some default files. More details can be found in the [contributing animations](/docs/contributing/animations) documentation.
