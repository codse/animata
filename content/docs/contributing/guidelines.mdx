...
- Use [radiux icon](https://www.radix-ui.com/icons) or [lucide icon](https://lucide.dev/icons/) for icons.
- If you need specific SVGs, use [flaticon.com](https://flaticon.com) and copy the SVG. Make sure to add the credits in the documentation for the icon.

## Imports

All imports should be `absolute`, i.e., use `@animata/...` instead of relative imports like `./` or `../`. I have added `import issue` in the comments for such issues.
