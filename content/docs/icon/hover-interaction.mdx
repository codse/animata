...
```
import HoverInteraction from "path of hover-interaction.tsx"
<HoverInteraction title={twitter/x} size={4}/>
```

**Other than defaults**

**Check how the defaults are imported and used for better understanding**
