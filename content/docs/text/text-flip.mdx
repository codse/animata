---
title: Text Flip
description: Text with flipping effect — built with Tailwind CSS for headings, hero copy, and attention-grabbing labels.
author: AashishKatila
---

<ComponentPreview name="text-text-flip--primary" />

## Installation

### CLI

<RegistryInstall category="text" name="text-flip" />
