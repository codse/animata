---
title: Swap Card
description: When button is toggle card swipes up and down with Lucide icons — built with Tailwind CSS for marketing pages and product landings.
labels: ["requires interaction", "toggle"]
author: Sumingurung9
---

<ComponentPreview name="card-swap-card--primary" />

## Installation

### CLI

<RegistryInstall category="feature-cards" name="swap-card" />
