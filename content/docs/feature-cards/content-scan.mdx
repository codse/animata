...
<ComponentPreview name="feature-cards-content-scan--primary" />

## Installation

### CLI

<RegistryInstall category="feature-cards" name="content-scan" />
...
```css
@theme {
  --bg-custom-gradient: linear-gradient(to left, rgba(136,127,242,0.7) 0%, transparent 100%);
}
```
