...
description: An intro hero inspired by Slack's intro screen with timed animations — built with Tailwind CSS for landing pages and marketing sites.
author: AashishKatila
---

<ComponentPreview name="hero-slack-intro--primary" />

## Installation

### CLI

<RegistryInstall category="hero" name="slack-intro" />
