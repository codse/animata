...
description: Hover on "Uncharted Adventures" and "Feel Alive" text to reveal the images with Lucide icons and 3D transforms — built with Tailwind CSS.
labels: ["requires interaction", "hover"]
author: RBchiranjibi
---

<ComponentPreview name="hero-hero-section-text-hover--primary" />

## Installation

### CLI

<RegistryInstall category="hero" name="hero-section-text-hover" />
