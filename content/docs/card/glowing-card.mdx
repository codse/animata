---
title: Glowing Card
description: The card glows in gradient colours when hovered with hover interactions — built with Tailwind CSS for content previews, product displays, and dashboards.
