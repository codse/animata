...
Swap the card components in the `cards` array. Keep them at `w-48` unless you also update the grid gap and `--deck-step` in the CSS. The stage uses `overflow-x-auto` — adjust padding or scroll-snap there if you want a different narrow-screen feel.
