...
description: A trailing effect where the images move with the mouse — built with Tailwind CSS for galleries, portfolios, and media showcases.
author: harimanok_
labels: ["requires interaction", "hover"]
---

<ComponentPreview name="image-trailing-image--primary" />

## Installation

### CLI

<RegistryInstall category="image" name="trailing-image" />
