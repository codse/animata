...
## Credits
   ...
   Built by [Eshan Singh](https://github.com/R0X4R) with the help of [Framer Motion](https://www.framer.com/motion/) and [React Icons](https://react-icons.github.io/react-icons/). Inspired by [Build UI](https://buildui.com/recipes/magnified-dock)
