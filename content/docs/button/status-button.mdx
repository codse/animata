---
title: Status Button
description: A button that transitions the status change. Click to see the animation with smooth Motion animations and Lucide icons — built with Tailwind CSS.
author: harimanok_
