...
We’re offering a **$50 reward** to one lucky contributor based on a raffle system.
...
6. **Payment Eligibility:**  
   To qualify for the **$50 reward**, you must be able to **receive international payments** via platforms like PayPal.
