  ...
  return (
    <>
      <div
        ...
        className="relative overflow-x-hidden overflow-y-visible bg-background"
      >
        <DiagonalLines
          color={diagonalColor}
          className="absolute -top-10 z-[2] h-24 w-24 -translate-x-10 rotate-12 md:-top-20 md:h-52 md:w-52 md:-translate-x-20"
        >
          <ComponentLinkWrapper link="/docs/background/diagonal-lines">
            <div className="h-24 w-24 md:h-52 md:w-52" />
          </ComponentLinkWrapper>
        </DiagonalLines>
        <Dot
          color={diagonalColor}
          className="absolute -top-10 right-0 z-[2] h-24 w-24 translate-x-10 rotate-12 !bg-transparent md:-top-20 md:h-52 md:w-52 md:translate-x-20"
        >
