...
export default function Hero() {
  return (
    <div className="relative">
      <div
        className="absolute inset-0 h-full w-full mix-blend-hard-light dark:opacity-50 dark:mix-blend-soft-light"
        style={{
          ...
          // maskImage: "linear-gradient(90deg, #0000, #000 50%)",
        }}
      />
      <div className="container relative overflow-hidden py-12 md:py-32">
        ...
        <Pill className="left-12 top-12 rotate-3">80+ components</Pill>
        <Pill className="right-12 top-12 -translate-y-1/2 -rotate-6">600+ stars</Pill>
        ...
        <Pill className="bottom-12 left-12 aspect-square -translate-y-full translate-x-full">
          <Icons.framerMotion className="size-6" />
        </Pill>
        <Pill className="bottom-12 right-12 aspect-square -translate-x-full -translate-y-full p-2">
        ...
        <Pill className="right-12 top-12 aspect-square translate-y-full p-1">
          <Icons.yarn className="size-10" />
        </Pill>
        <Pill className="left-12 top-12 aspect-square translate-y-full p-2">
